...
const locations = [
  {
    ...
    text: "Você está na praça da cidade. Você vê um cartaz que diz \"Loja\"."
  },
  {
    name: "loja",
    "button text": ["Comprar 10 de saúde (10 ouro)", "Comprar arma (30 ouro)", "Ir para a praça da cidade"],
    "button functions": [buyHealth, buyWeapon, goTown],
    text: "Você entra na loja."
  },
  {
    name: "caverna",
    "button text": ["Lutar contra a gosma", "Lutar contra a besta com presas", "Ir para a praça da cidade"],
  ...
  },
  {
    ...
    text: "Você encontra um jogo secreto. Escolha um número acima. Dez números serão escolhidos aleatoriamente entre 0 e 10. Se o número escolhido coincidir com um dos números aleatórios, você vence!"
  }
];
...
function attack() {
  ...
  text.innerText += " Você a ataca com sua " + weapons[currentWeapon].name + ".";
...
function dodge() {
  text.innerText = "Você desvia do ataque da " + monsters[fighting].name;
}
...
function pick(guess) {
  ...
  if (numbers.includes(guess)) {
    text.innerText += "Acertou! Você ganha 20 ouro!";
    gold += 20;
    goldText.innerText = gold;
  } else {
    text.innerText += "Errou! Você perde 10 de saúde!";
    health -= 10;
    healthText.innerText = health;
    if (health <= 0) {
      lose();
